...
export interface CreateDataSourceCVConfigQueryParams {
  accountId?: string
}

export interface CreateDataSourceCVConfigPathParams {
  identifier: string
}

export type CreateDataSourceCVConfigProps = Omit<
  MutateProps<
    void,
    Failure | Error,
    CreateDataSourceCVConfigQueryParams,
    DSConfigRequestBody,
    CreateDataSourceCVConfigPathParams
  >,
  'path' | 'verb'
> &
  CreateDataSourceCVConfigPathParams
 ...
 * creates a data source config
 */
export const CreateDataSourceCVConfig = ({ identifier, ...props }: CreateDataSourceCVConfigProps) => (
  <Mutate<
    void,
    Failure | Error,
    CreateDataSourceCVConfigQueryParams,
...
export type UseCreateDataSourceCVConfigProps = Omit<
  UseMutateProps<
    void,
    Failure | Error,
    CreateDataSourceCVConfigQueryParams,
 ...
 * creates a data source config
 */
export const useCreateDataSourceCVConfig = ({ identifier, ...props }: UseCreateDataSourceCVConfigProps) =>
  useMutate<
    void,
    Failure | Error,
    CreateDataSourceCVConfigQueryParams,
    DSConfigRequestBody,
    CreateDataSourceCVConfigPathParams
  >('PUT', (paramsInPath: CreateDataSourceCVConfigPathParams) => `/ds-config/${paramsInPath.identifier}`, {
    base: getConfig('cv/api'),
 ...
 * creates a data source config
 */
export const createDataSourceCVConfigPromise = (
  {
    identifier,
    ...props
  ...
  mutateUsingFetch<
    ...
    DSConfigRequestBody,
    CreateDataSourceCVConfigPathParams
  >('PUT', getConfig('cv/api'), `/ds-config/${identifier}`, props, signal)
...
export type SaveVerificationJobProps = Omit<
  MutateProps<void, Failure | Error, SaveVerificationJobQueryParams, VerificationJobDTO, void>,
  'path' | 'verb'
>
...
export const SaveVerificationJob = (props: SaveVerificationJobProps) => (
  <Mutate<void, Failure | Error, SaveVerificationJobQueryParams, VerificationJobDTO, void>
    verb="PUT"
    path="/verification-job"
    base={getConfig('cv/api')}
    {...props}
...
export type UseSaveVerificationJobProps = Omit<
  UseMutateProps<void, Failure | Error, SaveVerificationJobQueryParams, VerificationJobDTO, void>,
  'path' | 'verb'
>
...
export const useSaveVerificationJob = (props: UseSaveVerificationJobProps) =>
  useMutate<void, Failure | Error, SaveVerificationJobQueryParams, VerificationJobDTO, void>(
    'PUT',
    `/verification-job`,
    { base: getConfig('cv/api'), ...props }
  )
...
export const saveVerificationJobPromise = (
  props: MutateUsingFetchProps<void, Failure | Error, SaveVerificationJobQueryParams, VerificationJobDTO, void>,
  signal?: RequestInit['signal']
) =>
  mutateUsingFetch<void, Failure | Error, SaveVerificationJobQueryParams, VerificationJobDTO, void>(
    'PUT',
    getConfig('cv/api'),
    `/verification-job`,
    props,
