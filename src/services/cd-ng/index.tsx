...
export interface InfrastructureDef {
  ...
  spec: Infrastructure
  type: 'KubernetesDirect' | 'KubernetesGcp' | 'KubernetesAzure' | 'Pdc'
}
...
export interface PrimaryArtifact {
  spec: ArtifactConfig
  type: 'DockerRegistry' | 'Gcr' | 'Ecr' | 'Acr' | 'Nexus3Registry' | 'ArtifactoryRegistry'
}
...
export const useGetAzureSubscriptions = (props: UseGetAzureSubscriptionsProps) =>
  useGet<ResponseMapStringString, Failure | Error, GetAzureSubscriptionsQueryParams, void>(
...
export interface GetAzureRegistriesBySubscriptionQueryParams {
  connectorRef: string
  accountIdentifier: string
  orgIdentifier: string
  projectIdentifier: string
...
export interface GetAzureRegistriesBySubscriptionPathParams {
  subscription: string
}

export type GetAzureRegistriesBySubscriptionProps = Omit<
  GetProps<
    ResponseListString,
    Failure | Error,
    GetAzureRegistriesBySubscriptionQueryParams,
    GetAzureRegistriesBySubscriptionPathParams
  >,
  'path'
> &
  GetAzureRegistriesBySubscriptionPathParams
...
/**
 * Gets azure registries by subscription
 */
export const GetAzureRegistriesBySubscription = ({ subscription, ...props }: GetAzureRegistriesBySubscriptionProps) => (
  <Get<
    ResponseListString,
    Failure | Error,
    GetAzureRegistriesBySubscriptionQueryParams,
...
export type UseGetAzureRegistriesBySubscriptionProps = Omit<
  UseGetProps<
    ResponseListString,
    Failure | Error,
    GetAzureRegistriesBySubscriptionQueryParams,
 ...
 * Gets azure registries by subscription
 */
export const useGetAzureRegistriesBySubscription = ({
  subscription,
  ...props
}: UseGetAzureRegistriesBySubscriptionProps) =>
  useGet<
    ResponseListString,
    Failure | Error,
    GetAzureRegistriesBySubscriptionQueryParams,
    GetAzureRegistriesBySubscriptionPathParams
  >(
    (paramsInPath: GetAzureRegistriesBySubscriptionPathParams) =>
      `/artifacts/acr/subscriptions/${paramsInPath.subscription}/container-registries`,
 ...
 * Gets azure registries by subscription
 */
export const getAzureRegistriesBySubscriptionPromise = (
  {
    subscription,
    ...props
  }: GetUsingFetchProps<
  ...
  getUsingFetch<
    ...
    GetAzureRegistriesBySubscriptionQueryParams,
    GetAzureRegistriesBySubscriptionPathParams
  >(getConfig('ng/api'), `/artifacts/acr/subscriptions/${subscription}/container-registries`, props, signal)

export interface GetAzureRepositoriesQueryParams {
  connectorRef: string
  accountIdentifier: string
  orgIdentifier: string
  projectIdentifier: string
...
export interface GetAzureRepositoriesPathParams {
  subscription: string
  registry: string
}

export type GetAzureRepositoriesProps = Omit<
  GetProps<ResponseListString, Failure | Error, GetAzureRepositoriesQueryParams, GetAzureRepositoriesPathParams>,
  'path'
> &
  GetAzureRepositoriesPathParams

/**
 * Gets azure repositories by subscription and container registry name
 */
export const GetAzureRepositories = ({ subscription, registry, ...props }: GetAzureRepositoriesProps) => (
  <Get<ResponseListString, Failure | Error, GetAzureRepositoriesQueryParams, GetAzureRepositoriesPathParams>
...
export type UseGetAzureRepositoriesProps = Omit<
  UseGetProps<ResponseListString, Failure | Error, GetAzureRepositoriesQueryParams, GetAzureRepositoriesPathParams>,
  'path'
> &
  GetAzureRepositoriesPathParams
 ...
 * Gets azure repositories by subscription and container registry name
 */
export const useGetAzureRepositories = ({ subscription, registry, ...props }: UseGetAzureRepositoriesProps) =>
  useGet<ResponseListString, Failure | Error, GetAzureRepositoriesQueryParams, GetAzureRepositoriesPathParams>(
    (paramsInPath: GetAzureRepositoriesPathParams) =>
      `/artifacts/acr/subscriptions/${paramsInPath.subscription}/container-registries/${paramsInPath.registry}/repositories`,
    { base: getConfig('ng/api'), pathParams: { subscription, registry }, ...props }
  )

/**
 * Gets azure repositories by subscription and container registry name
 */
export const getAzureRepositoriesPromise = (
  {
    subscription,
    registry,
    ...props
    ...
    ResponseListString,
    Failure | Error,
    GetAzureRepositoriesQueryParams,
    GetAzureRepositoriesPathParams
  > & { subscription: string; registry: string },
  signal?: RequestInit['signal']
) =>
  getUsingFetch<ResponseListString, Failure | Error, GetAzureRepositoriesQueryParams, GetAzureRepositoriesPathParams>(
    getConfig('ng/api'),
...
export const GetAzureResourceGroupsBySubscription = ({
  ...
  <Get<
    ...
    GetAzureResourceGroupsBySubscriptionPathParams
  >
    path={`/artifacts/acr/subscriptions/${subscription}/resourceGroups`}
    base={getConfig('ng/api')}
    {...props}
  />
)
...
export const useGetAzureResourceGroupsBySubscription = ({
  ...
  >(
    (paramsInPath: GetAzureResourceGroupsBySubscriptionPathParams) =>
      `/artifacts/acr/subscriptions/${paramsInPath.subscription}/resourceGroups`,
    { base: getConfig('ng/api'), pathParams: { subscription }, ...props }
  )
...
export const getAzureResourceGroupsBySubscriptionPromise = (
  ...
  getUsingFetch<
    ...
    GetAzureResourceGroupsBySubscriptionQueryParams,
    GetAzureResourceGroupsBySubscriptionPathParams
  >(getConfig('ng/api'), `/artifacts/acr/subscriptions/${subscription}/resourceGroups`, props, signal)
...
export const GetAzureClusters = ({ subscription, resourceGroup, ...props }: GetAzureClustersProps) => (
  <Get<ResponseListString, Failure | Error, GetAzureClustersQueryParams, GetAzureClustersPathParams>
    path={`/artifacts/acr/subscriptions/${subscription}/resourceGroups/${resourceGroup}/clusters`}
    base={getConfig('ng/api')}
    {...props}
  />
)
...
export const useGetAzureClusters = ({ subscription, resourceGroup, ...props }: UseGetAzureClustersProps) =>
  useGet<ResponseListString, Failure | Error, GetAzureClustersQueryParams, GetAzureClustersPathParams>(
    (paramsInPath: GetAzureClustersPathParams) =>
      `/artifacts/acr/subscriptions/${paramsInPath.subscription}/resourceGroups/${paramsInPath.resourceGroup}/clusters`,
...
export const getAzureClustersPromise = (
  ...
  getUsingFetch<ResponseListString, Failure | Error, GetAzureClustersQueryParams, GetAzureClustersPathParams>(
    getConfig('ng/api'),
    `/artifacts/acr/subscriptions/${subscription}/resourceGroups/${resourceGroup}/clusters`,
    props,
    signal
  )
