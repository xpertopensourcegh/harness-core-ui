...
import GITConnectorForm from '@connectors/pages/connectors/Forms/GITConnector/GITConnectorForm'
import DockerConnectorForm from '@connectors/pages/connectors/Forms/Docker/DockerConnectorForm'
