...
import { mockResponse, mockSecret, jenkinsMock } from './mocks'
import CreateJenkinsConnector from '../CreateJenkinsConnector'
...
describe('Create Jenkins Connector  Wizard', () => {
  ...
  test('Should render form for editing provider type', async () => {
    ...
    // step 2
    expect(queryByText(container, 'Jenkins Registry URL')).toBeDefined()
    expect(container).toMatchSnapshot()
