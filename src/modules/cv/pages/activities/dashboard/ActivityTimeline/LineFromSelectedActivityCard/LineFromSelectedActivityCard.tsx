...
interface LineFromSelectedActivityCardProps {
  selectedActivity?: Activity | null
  selectedActivitySummaryCardRef: HTMLDivElement | null
  timelineContainerRef: HTMLDivElement | null
}

export default function LineFromSelectedActivityCard(props: LineFromSelectedActivityCardProps): JSX.Element | null {
  ...
  return (
    <svg width="100%" height="10px" style={{ position: 'absolute', top: y1, zIndex: 50 }} className={css.main}>
