...
export function validateMappings(
  ...
  const requiredFieldErrors = {
    ...
    ...(!values?.envIdentifier && {
      [MapGCPLogsToServiceFieldNames.ENVIRONMENT]: getString('cv.monitoringSources.envValidation')
    }),
    ...(!values?.serviceIdentifier && {
      [MapGCPLogsToServiceFieldNames.SERVICE]: getString('cv.monitoringSources.serviceValidation')
    }),
