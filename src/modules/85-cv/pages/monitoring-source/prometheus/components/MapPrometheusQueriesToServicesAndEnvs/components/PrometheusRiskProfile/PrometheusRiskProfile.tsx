  ...
  if (loading) {
    ...
    metricPackContent = (
      <FormInput.RadioGroup
        ...
        name={MapPrometheusQueryToServiceFieldNames.RISK_CATEGORY}
    ...
    <Container className={css.main}>
      ...
      <Container className={css.checkBoxGroup}>
        ...
        <FormInput.CheckBox
          ...
          name={MapPrometheusQueryToServiceFieldNames.HIGHER_BASELINE_DEVIATION}
        />
        <FormInput.CheckBox
          label={getString('cv.monitoringSources.lowerCounts')}
          name={MapPrometheusQueryToServiceFieldNames.LOWER_BASELINE_DEVIATION}
        />
      </Container>
      <FormInput.Select
        name={MapPrometheusQueryToServiceFieldNames.SERVICE_INSTANCE}
