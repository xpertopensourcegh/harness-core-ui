...
const CostReportingPopover = () => {
  ...
  const features: (keyof StringsMap)[] = useMemo(
    () => [
      'ce.cloudIntegration.costVisibilityDialog.popover.feat1',
      'ce.cloudIntegration.costVisibilityDialog.popover.feat2',
      'ce.cloudIntegration.costVisibilityDialog.popover.feat3',
      'ce.cloudIntegration.costVisibilityDialog.popover.feat4',
      'ce.cloudIntegration.costVisibilityDialog.popover.feat5',
      'ce.cloudIntegration.costVisibilityDialog.popover.feat6'
    ],
    []
  )
