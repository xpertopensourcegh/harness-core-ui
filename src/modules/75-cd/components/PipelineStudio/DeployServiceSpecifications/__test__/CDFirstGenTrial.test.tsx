...
describe('CDFirstGenTrial Test cases', () => {
  test('it should render the dialog with no deployment type', () => {
    ...
    expect(getByText('cd.cdSwitchToFirstGen.startWith14DayTrial')).toBeDefined()
  ...
  test('it should render the dialog with valid deployment type', () => {
    ...
    expect(container).toMatchSnapshot()
    const startWith14DayTrialBtn = getByText('cd.cdSwitchToFirstGen.startWith14DayTrial')
    fireEvent.click(startWith14DayTrialBtn)
