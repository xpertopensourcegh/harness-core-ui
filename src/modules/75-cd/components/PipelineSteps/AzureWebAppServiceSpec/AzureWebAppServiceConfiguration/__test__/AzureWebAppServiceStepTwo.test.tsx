...
import {
  ...
  prevStepDataRuntime,
  propStepTwo
} from './AppServiceConfigTestUtils'
...
describe('AzureWebAppServiceStepTwo', () => {
  ...
  test('load empty and go back', async () => {
    const { container } = render(
      <TestWrapper>
        <AzureWebAppServiceStepTwo {...propStepTwo} initialValues={{} as any} previousStep={onBack} />
      </TestWrapper>
    )
