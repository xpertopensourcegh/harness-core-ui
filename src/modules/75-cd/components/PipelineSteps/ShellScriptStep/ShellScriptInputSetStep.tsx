...
import { getMultiTypeFromValue, MultiTypeInputType, FormInput, FormikForm, Formik } from '@wings-software/uicore'
import { isEmpty, get, isArray, noop } from 'lodash-es'
...
export default function ShellScriptInputSetStep(props: ShellScriptInputSetStepProps): React.ReactElement {
  ...
  return (
    <Formik formName={'shellScriptInputSetStep'} initialValues={{}} onSubmit={noop}>
      <FormikForm>
