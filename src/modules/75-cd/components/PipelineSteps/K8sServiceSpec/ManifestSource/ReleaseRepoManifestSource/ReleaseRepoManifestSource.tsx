...
export class ReleaseRepoManifestSource extends ManifestSourceBase<ManifestSourceRenderProps> {
  protected manifestType = ReleaseRepoManifestDataType.ReleaseRepo
