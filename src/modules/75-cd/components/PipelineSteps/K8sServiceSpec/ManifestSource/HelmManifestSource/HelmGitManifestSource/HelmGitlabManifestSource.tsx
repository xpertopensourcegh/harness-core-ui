...
export class HelmGitlabManifestSource extends ManifestSourceBase<ManifestSourceRenderProps> {
  protected manifestType = `${ManifestDataType.HelmChart}-${ManifestStoreMap.GitLab}`
