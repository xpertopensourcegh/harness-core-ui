...
import { template, artifacts, regions } from './mocks'
...
describe('ECR Artifact Source tests', () => {
  test('snapshot test for Primary ECR artifact source', () => {
  ...
  test('snapshot test for Sidecar ECR artifact source', async () => {
