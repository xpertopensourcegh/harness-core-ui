...
import { getMultiTypeFromValue, MultiTypeInputType, FormInput, FormikForm, Text, Formik } from '@wings-software/uicore'
        ...
        {getMultiTypeFromValue(inputSetData?.template?.spec?.configuration?.targets as string) ===
          ...
          <div className={cx(stepCss.formGroup, stepCss.md)}>
            <List
              ...
              label={
                <Text style={{ display: 'flex', alignItems: 'center' }}>{getString('pipeline.targets.title')}</Text>
              }
              disabled={readonly}
