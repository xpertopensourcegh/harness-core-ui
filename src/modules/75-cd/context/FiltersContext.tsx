...
import type { EnvironmentGroupFilterProperties, FilterDTO, GetEnvironmentGroupListQueryParams } from 'services/cd-ng'

export type QueryParams = Partial<GetEnvironmentGroupListQueryParams> & {
