...
import css from '@dashboards/components/ServiceDetails/InstanceCountHistory/InstanceCountHistory.module.scss'
  ...
  return (
    <Card className={css.instanceCountHistory}>
      <Text font={{ weight: 'semi-bold' }} color={Color.GREY_600} margin={{ bottom: 'small' }}>
        {getString('dashboards.serviceDashboard.instanceCountHistory')}
      </Text>
      {getComponent()}
    </Card>
  )
