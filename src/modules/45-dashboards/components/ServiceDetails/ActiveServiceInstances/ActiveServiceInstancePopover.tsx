...
export const ActiveServiceInstancePopover: React.FC<ActiveServiceInstancePopoverProps> = props => {
  ...
  const sectionData: SectionProps[] = [
    {
      header: getString('dashboards.serviceDashboard.instanceDetails'),
      values: [
        {
          label: getString('dashboards.serviceDashboard.pod'),
          value: instanceData.podName || ''
        },
        {
          label: getString('dashboards.serviceDashboard.artifact'),
    ...
    },
    {
      ...
      values: [
        {
          label: getString('dashboards.serviceDashboard.deployedAt'),
          value: instanceData.deployedAt
        },
        {
          label: getString('dashboards.serviceDashboard.deployedBy'),
