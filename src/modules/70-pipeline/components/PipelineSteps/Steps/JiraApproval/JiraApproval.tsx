...
export class JiraApproval extends PipelineStep<JiraApprovalData> {
  ...
  validateInputSet(
    ...
    if (
      ...
      errors.spec = {
        connectorRef: getString?.('jiraApprovalStep.validations.connectorRef')
      }
    }
    ...
    if (
      ...
      errors.spec = {
        projectKey: getString?.('jiraApprovalStep.validations.project')
      }
    }
    ...
    if (
      ...
      errors.spec = {
        issueType: getString?.('jiraApprovalStep.validations.issueType')
      }
    }
    ...
    if (
      ...
      errors.spec = {
        issueKey: getString?.('jiraApprovalStep.validations.issueKey')
      }
    }
    ...
    if (
      ...
      errors.spec = {
        ...errors.spec,
        approvalCriteria: { spec: { expression: getString?.('jiraApprovalStep.validations.expression') } }
      }
    }
