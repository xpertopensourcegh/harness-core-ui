...
import { RestoreCacheS3StepBase } from './RestoreCacheS3StepBase'
...
export class RestoreCacheS3Step extends PipelineStep<RestoreCacheS3StepData> {
  ...
  renderStep(
    ...
    onUpdate?: (data: RestoreCacheS3StepData) => void,
    stepViewType?: StepViewType,
    inputSetData?: InputSetData<RestoreCacheS3StepData>
  ): JSX.Element {
    ...
    return <RestoreCacheS3StepBase initialValues={initialValues} onUpdate={onUpdate} stepViewType={stepViewType} />
  }
}
