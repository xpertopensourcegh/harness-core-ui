...
import {
  /* SelectOption, FormInput, getMultiTypeFromValue, MultiTypeInputType, Button, */ Text
...
import type { FlagConfigurationStepFormData /* HttpStepHeaderConfig */ } from './types'

// import stepCss from '@pipeline/components/PipelineSteps/Steps/Steps.module.scss'

export default function FlagConfigurationStepBase(_props: {
  ...
  return (
    <Text>FlagConfigurationStepBase: To be implemented</Text>
