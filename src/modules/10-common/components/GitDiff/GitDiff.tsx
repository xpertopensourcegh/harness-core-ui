...
export const GitDiff = ({
  ...
  const [currentContent, setCurrentContent] = useState<string>(localVersion)
  ...
  return (
    <Layout.Vertical>
      ...
      <Layout.Horizontal
        ...
        padding={{ left: 'medium', right: 'huge', top: 'medium', bottom: 'medium' }}
      ...
      <Container className={css.footer}>
        ...
        <Text padding={{ right: 'medium' }} font={{ size: 'small', mono: true }}>
          {getString('common.newLines')} {getNewLineCount(linesChangedInModifiedContent)}
        </Text>
      </Container>
    </Layout.Vertical>
  )
