...
import DefaultRenderer from '@common/pages/ProjectsPage/views/ModuleRenderer/DefaultRenderer'
import CVRenderer from '@common/pages/ProjectsPage/views/ModuleRenderer/cv/CVRenderer'
import CDRenderer from '@common/pages/ProjectsPage/views/ModuleRenderer/cd/CDRenderer'
