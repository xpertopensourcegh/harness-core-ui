...
import type { GitCloneStepData } from './GitCloneStep'
import { flatObject } from '../StepsFlatObject'

export interface GitCloneStepVariablesProps {
  initialValues: GitCloneStepData
  stageIdentifier: string
  onUpdate?(data: GitCloneStepData): void
  metadataMap: Required<VariableMergeServiceResponse>['metadataMap']
  variablesData: GitCloneStepData
}

export const GitCloneStepVariables: React.FC<GitCloneStepVariablesProps> = ({
  variablesData,
  metadataMap,
  initialValues
