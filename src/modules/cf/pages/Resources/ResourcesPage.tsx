          ...
          <Container>
            <Layout.Horizontal spacing="medium">
              <NavLink
                ...
                to={routes.toCFAdminResourcesConnectors({ accountId, orgIdentifier, projectIdentifier })}
              >
                {i18n.connectors}
              </NavLink>
              ...
              <NavLink
                className={css.tags}
                activeClassName={css.activeTag}
                to={routes.toCFAdminResourcesSecretsListing({ accountId, orgIdentifier, projectIdentifier })}
              >
                {i18n.secrets}
              </NavLink>
